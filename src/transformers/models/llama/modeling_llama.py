...
# Use SharedRotaryEmbedding instead of LlamaRotaryEmbedding
LlamaRotaryEmbedding = SharedRotaryEmbedding
...
# Use SharedDecoderLayer instead of LlamaDecoderLayer
LlamaDecoderLayer = SharedDecoderLayer
