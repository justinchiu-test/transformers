...
# Use SharedMLP for the MoE experts
MixtralBlockSparseTop2MLP = SharedMLP


class MixtralSparseMoeBlock(SharedMoE):
    """
    Mixtral MoE block using SharedMoE.
    This implementation is strictly equivalent to standard MoE with full capacity.
    """
...
MixtralRotaryEmbedding = SharedRotaryEmbedding
