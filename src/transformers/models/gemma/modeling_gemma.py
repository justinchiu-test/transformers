...
# Use SharedDecoderLayer instead of GemmaDecoderLayer
# SharedDecoderLayer automatically detects Gemma and uses add_unit_offset=True
GemmaDecoderLayer = SharedDecoderLayer
