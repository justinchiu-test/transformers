...
# Use SharedRotaryEmbedding instead of GemmaRotaryEmbedding
GemmaRotaryEmbedding = SharedRotaryEmbedding
...
class GemmaDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: GemmaConfig, layer_idx: int):
        ...
        self.input_layernorm = SharedRMSNorm(config.hidden_size, eps=config.rms_norm_eps, add_unit_offset=True)
        self.post_attention_layernorm = SharedRMSNorm(config.hidden_size, eps=config.rms_norm_eps, add_unit_offset=True)
